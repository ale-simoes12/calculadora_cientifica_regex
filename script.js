...
document.addEventListener("keydown", function (event) {
 ...
 console.log("val" , validarProximoCaractere(equacao, teclaFisica))
  if (teclaFisica === "Backspace") {
    ...
    hoverTecla(botaoApagar);
      ...
      equacao = "";
      const botaoApagarTudo = teclasVirtuais[2];
...
function adicionaEquacao(teclasVirtuais, textoTeclaVirtual, teclaFisica) {
